...
document.addEventListener('DOMContentLoaded', function() {
    const dynamicTable = new DynamicTable("#orderTable", {
        data: [],
        columns: ["Sl", "Customer Details", "Items Ordered", "Order Date", "Total", "Mode", "Delivery Address", "Order Status"],
        searchInput: "#search-input",
        rowsPerPageSelect: "#rows-per-page",
        paginationContainer: ".pagination",
        paginationInfo: ".pagination-info",
        sortableColumns: ["Sl", "Total", "Mode"],
        centerAlignedColumns: ["Sl", "Order Status"] 
    });
    ...
    function generateTableRows() {
        const ordersData = [
            ...
            %>
            {
                ...
                "Order Status": `<form action="UpdateOrderStatus" method="POST">
